...
You can see an interactive session [here](https://gvegayon.github.io/gallery/20250113-ideas-investigators/coauthor/). A pdf version of the visualization can be found [here](coauthors.pdf).
